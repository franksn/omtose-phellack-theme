...
(let (
      ...
      (omtose-phellack-darkslategray4  (if (display-graphic-p) "#528B8B" "DarkSlateGray4"))
      )
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-identifiers-identifier-5          ((t (:foreground ,omtose-phellack-bright_magenta))))
   ...
   `(ido-only-match                            ((t (:foreground ,omtose-phellack-darkslategray4))))
   ...
   `(elscreen-tab-control-face                 ((t (:foreground ,omtose-phellack-neutral_red :background ,omtose-phellack-dark2 :box nil :underline nil)))) ;; The controls
   `(elscreen-tab-current-screen-face          ((t (:foreground ,omtose-phellack-dark0 :background ,omtose-phellack-dark4 :box nil)))) ;; Current tab
   `(elscreen-tab-other-screen-face            ((t (:foreground ,omtose-phellack-light4 :background ,omtose-phellack-dark2 :box nil :underline nil)))) ;; Inactive tab
   ...
   ;; sh mode
   `(sh-heredoc                                ((t (:foreground ,omtose-phellack-darkslategray4 :background nil))))
   `(sh-quoted-exec                            ((t (:foreground ,omtose-phellack-darkslategray4 :background nil))))
   ...
   `(company-tooltip-common-selection          ((t (:foreground ,omtose-phellack-light0 :background ,omtose-phellack-neutral_blue))))
   ...
   ;; helm
   `(helm-M-x-key                              ((t (:foreground ,omtose-phellack-neutral_blue))))
   ...
   `(magit-tag                          ((t (:foreground ,omtose-phellack-darkslategray4))))
