...
(defun create-omtose-phellack-theme (theme-name)
  (let ((class '((class color) (min-colors 89)))
    ...
    (custom-theme-set-faces
     ...
     ;; Org-mode
     `(org-agenda-date-today                     ((,class (:foreground ,light2 :slant italic :weight bold :height ,(if omtose-theme-org-height 1.2 1.0)))))
     ...
     `(org-document-title                        ((,class (:foreground ,neutral_green :weight bold :height ,(if omtose-theme-org-height 1.3 1.0) :underline t))))
     ...
     `(org-level-1                               ((,class (:foreground ,bright_blue :height ,(if omtose-theme-org-height 1.2 1.0)))))
     `(org-level-2                               ((,class (:foreground ,bright_green :height ,(if omtose-theme-org-height 1.1 1.0)))))
     ...
     `(org-scheduled-today                       ((,class (:foreground ,bright_blue :height ,(if omtose-theme-org-height 1.1 1.0)))))
