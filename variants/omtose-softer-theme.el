...
(let* (;; variable pitch
       ...
       (bright_red      "#D479CE")
       (bright_green    "#81CCBF")
       (bright_yellow   "#A5D9B7")
       (bright_blue     "#72A7D4")
       (bright_purple   "#8A90D4")
       (bright_cyan     "#AEAECF")

        ;; Needs some work
       (neutral_red    "#BF63C7")
       (neutral_green  "#76B8AD")
       (neutral_yellow "#DB9595")
       (neutral_blue   "#678DB5")
       (neutral_purple "#7E84BD")
       (neutral_cyan   "#8191B8")
    ...
    (custom-theme-set-faces
     ...
     `(company-preview-search                    ((,class (:foreground ,bright_red :weight bold))
     ...
     `(company-tooltip-common                    ((,class (:foreground ,light1 :background ,dark0_soft))
                                                  (,t-class (:foreground ,t-light1 :background ,t-dark0_soft))))
     `(company-tooltip-annotation                ((,class (:foreground ,light4 :background ,dark0_soft))
                                                  (,t-class (:foreground ,t-light4 :background ,t-dark0_soft))))
     ...
     `(company-tooltip-common-selection          ((,class (:foreground ,bright_red :background ,dark_blue))
                                                  (,t-class (:foreground ,t-bright_red :background ,t-dark_blue))))
     `(company-tooltip-mouse                     ((,class (:foreground ,dark0 :background ,bright_blue))
                                                  (,t-class (:foreground ,t-dark0 :background ,t-bright_blue))))
     `(company-tooltip-selection                 ((,class (:foreground ,bright_red :background ,dark_blue))
                                                  (,t-class (:foreground ,t-bright_red :background ,t-dark_blue))))
     ...
     `(ivy-minibuffer-match-face-2               ((,class (:foreground ,bright_green :weight bold))
                                                  (,t-class (:foreground ,t-bright_green :weight bold))))
     `(ivy-minibuffer-match-face-3               ((,class (:foreground ,bright_purple))
                                                  (,t-class (:foreground ,t-bright_purple))))
    ...
    ;; cscope, ERC, evil (perhaps), Gnus, etc.
     ...
     (custom-theme-set-variables
      ...
      `(xterm-color-names-bright
        [,med_dark ,bright_red ,bright_green ,bright_yellow ,bright_blue ,bright_purple ,bright_cyan ,light0_hard]))))
