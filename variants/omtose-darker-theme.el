...
(let* (;; variable pitch
    ...
    (custom-theme-set-faces
     ...
     ;; Built-in syntax
     `(font-lock-builtin-face                    ((,class (:foreground ,neutral_cyan))
     ...
     `(diff-removed                              ((,class (:foreground ,light0 :background ,dark_green))
                                                  (,t-class (:foreground ,t-light0 :background ,t-dark_green))))
...
;;;;; mingus
     ...
     ;; Org-mode
     `(org-agenda-date-today                     ((,class (:foreground ,light2 :slant italic :weight bold :height ,(if omtose-darker-org-height 1.2 1.0)))
                                                  (,t-class (:foreground ,t-light2 :slant italic :weight bold :height ,(if omtose-darker-org-height 1.2 1.0)))))
     ...
     `(org-deadline-announce                     ((,class (:foreground ,neutral_red))
                                                  (,t-class (:foreground ,t-neutral_red))))
     `(org-document-title                        ((,class (:background ,dark0_hard :foreground ,neutral_green :weight bold :height ,(if omtose-darker-org-height 1.3 1.0) :underline t))
                                                  (,t-class (:background ,t-dark0_hard :foreground ,t-neutral_green :weight bold :height ,(if omtose-darker-org-height 1.3 1.0) :underline t))))
     ...
     `(org-hide                                  ((,class (:foreground ,dark0))
                                                  (,t-class (:foreground ,t-dark0))))
     `(org-level-1                               ((,class (:background ,dark_blue :foreground ,bright_blue :height ,(if omtose-darker-org-height 1.2 1.0)))
                                                  (,t-class (:background ,t-dark_blue :foreground ,t-bright_blue :height ,(if omtose-darker-org-height 1.2 1.0)))))
     `(org-level-2                               ((,class (:background ,dark_green :foreground ,bright_green :height ,(if omtose-darker-org-height 1.1 1.0)))
                                                  (,t-class (:background ,t-dark_green :foreground ,t-bright_green :height ,(if omtose-darker-org-height 1.1 1.0)))))
     ...
     `(org-scheduled-previously                  ((,class (:foreground ,bright_red))
                                                  (,t-class (:foreground ,t-bright_red))))
     `(org-scheduled-today                       ((,class (:foreground ,bright_blue :height ,(if omtose-darker-org-height 1.1 1.0)))
                                                  (,t-class (:foreground ,t-bright_blue :height ,(if omtose-darker-org-height 1.1 1.0)))))
