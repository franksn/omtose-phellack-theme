...
;; URL: http:/github.com/franksn/omtose-phellack/
...
(deftheme omtose-phellack "Dark and soothing colorscheme, with cool bluish touch")

(defgroup omtose-phellack nil
  "omtose-phellack options."
  :group 'faces)

(defcustom omtose-phellack-variable-pitch t
  "Use variable pitch for latex, markdown, or org-mode"
  :type 'boolean
  :group 'omtose-phellack)

(defcustom omtose-phellack-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'omtose-phellack)

(defcustom omtose-phellack-tex-height-90 0.9
  "Font size 90%"
  :type 'number
  :group 'omtose-phellack)

(defcustom omtose-phellack-tex-height-110 1.1
  "Font size 110%"
  :type 'number
  :group 'omtose-phellack)

(defcustom omtose-phellack-tex-height-120 1.2
  "Font size 120%"
  :type 'number
  :group 'omtose-phellack)

(defcustom omtose-phellack-tex-height-130 1.3
  "Font size 130%"
  :type 'number
  :group 'omtose-phellack)

(let* (;; variable pitch
       (omtose-phellack-pitch (if omtose-phellack-variable-pitch
                                  'variable-pitch
                                'default))
    ...
    (custom-theme-set-faces
     ...
     `(font-latex-sectioning-4-face              ((,class (:inherit font-latex-sectioning-5-face
                                                  ...
                                                  (,t-class (:inherit font-latex-sectioning-5-face
                                                                      :height ,omtose-phellack-tex-height-110))))
     `(font-latex-sectioning-5-face              ((,class (:inherit ,omtose-phellack-pitch :foreground ,bright_yellow
                                                                    :weight bold))
                                                  (,t-class (:inherit ,omtose-phellack-pitch :foreground ,t-bright_yellow
                                                                      :weight bold))))
     `(font-latex-sedate-face                    ((,class (:foreground ,dark4))
                                                  (,t-class (:foreground ,t-dark4))))
     `(font-latex-slide-title-face               ((,class (:inherit (,omtose-phellack-pitch font-lock-type-face)
                                                                    :weight bold :height ,omtose-phellack-tex-height-130))
                                                  (,t-class (:inherit (,omtose-phellack-pitch font-lock-type-face)
                                                                      :weight bold :height ,omtose-phellack-tex-height-130))))
     `(font-latex-string-face                    ((,class (:foreground ,bright_green))
                                                  (,t-class (:foreground ,t-bright_green))))
     `(font-latex-subscript-face                 ((,class (:height ,omtose-phellack-tex-height-90))
                                                  (,t-class (:height ,omtose-phellack-tex-height-90))))
     `(font-latex-superscript-face               ((,class (:height ,omtose-phellack-tex-height-90))
                                                  (,t-class (:height ,omtose-phellack-tex-height-90))))
     ...
     `(magit-diff-removed                        ((,class (:foreground ,bright_red :background ,dark_red))
                                                  (,t-class (:foreground ,t-bright_red :background ,t-dark_red))))
...
;;;;; mingus
     ...
     ;; Org-mode
     `(org-agenda-date-today                     ((,class (:foreground ,light2 :slant italic :weight bold :height ,(if omtose-phellack-org-height 1.2 1.0)))
                                                  (,t-class (:foreground ,t-light2 :slant italic :weight bold :height ,(if omtose-phellack-org-height 1.2 1.0)))))
     ...
     `(org-deadline-announce                     ((,class (:foreground ,neutral_red))
                                                  (,t-class (:foreground ,t-neutral_red))))
     `(org-document-title                        ((,class (:foreground ,neutral_green :weight bold :height ,(if omtose-phellack-org-height 1.3 1.0) :underline t))
                                                  (,t-class (:foreground ,t-neutral_green :weight bold :height ,(if omtose-phellack-org-height 1.3 1.0) :underline t))))
     ...
     `(org-hide                                  ((,class (:foreground ,dark0))
                                                  (,t-class (:foreground ,t-dark0))))
     `(org-level-1                               ((,class (:foreground ,bright_blue :height ,(if omtose-phellack-org-height 1.2 1.0)))
                                                  (,t-class (:foreground ,t-bright_blue :height ,(if omtose-phellack-org-height 1.2 1.0)))))
     `(org-level-2                               ((,class (:foreground ,bright_green :height ,(if omtose-phellack-org-height 1.1 1.0)))
                                                  (,t-class (:foreground ,t-bright_green :height ,(if omtose-phellack-org-height 1.1 1.0)))))
     ...
     `(org-scheduled-previously                  ((,class (:foreground ,bright_red))
                                                  (,t-class (:foreground ,t-bright_red))))
     `(org-scheduled-today                       ((,class (:foreground ,bright_blue :height ,(if omtose-phellack-org-height 1.1 1.0)))
                                                  (,t-class (:foreground ,t-bright_blue :height ,(if omtose-phellack-org-height 1.1 1.0)))))
