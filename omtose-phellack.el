...
(defun create-omtose-phellack-theme (theme-name)
  (let ((class '((class color) (min-colors 257)))
        ...
        (bright_red      "#A980C2")
        (bright_green    "#8ABFB7")
        (bright_yellow   "#ADC9C9")
        (bright_blue     "#6084A3")
        (bright_purple   "#7D85BA")
        (bright_cyan     "#95A5C4")

        ;; Needs some work
        (neutral_red     "#8E62A1")
        (neutral_green   "#72A8A2")
        (neutral_yellow  "#98B5A5")
        (neutral_blue    "#4C7191")
        (neutral_purple  "#6A6F99")
        (neutral_cyan    "#7D8CA8")
        ...
        (t-bright_red      "#D700AF")
        (t-bright_green    "#AFFFFF")
        (t-bright_yellow   "#AFD7D7")
        (t-bright_blue     "#87AFAF")
        (t-bright_purple   "#8787D7")
        (t-bright_cyan     "#AFAFD7")

        (t-neutral_red     "#AF87AF")
        (t-neutral_green   "#87AFD7")
        (t-neutral_yellow  "#87AFAF")
        (t-neutral_blue    "#5F87AF")
        (t-neutral_purple  "#5F5FAF")
        (t-neutral_cyan    "#8787AF")

        (t-dark_red        "#875FAF")
        (t-dark_green      "#5F5F5F")
        (t-dark_yellow     "#87AF87")
        (t-dark_blue       "#5F5F87")
        (t-dark_purple     "#5F5F87")
        (t-dark_cyan       "#0087af")
    ...
    (custom-theme-set-faces
     ...
     `(mode-line                                 ((,class (:foreground ,light1 :background ,dark0_hard :box nil))
                                                  (,t-class (:foreground ,t-light1 :background ,t-dark0_hard :box nil))))
     ...
     `(hl-line                                   ((,class (:background ,dark0_hard))
                                                  (,t-class (:foreground ,t-dark0_hard))))
     ...
     `(minibuffer-prompt                         ((,class (:foreground ,dark_yellow :background ,dark0 :bold nil))
                                                  (,t-class (:foreground ,t-dark_yellow :background ,t-dark0 :bold nil))))
     ...
     `(ido-first-match                           ((,class (:foreground ,bright_purple :background ,dark0_hard))
                                                  (,t-class (:foreground ,t-bright_purple :background ,t-dark0_hard))))
